...
Use research records to understand *why* a boundary exists. Use the formal
specification to understand *what* is normative, and use immutable QA evidence
to determine *whether* an implementation claim was actually proved. Product
